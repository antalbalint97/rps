...
CSV_PATH = os.path.join(BASE_DIR, "..", "training_data.csv")  # ../training_data.csv
MODEL_SAVE_PATH = os.path.join(BASE_DIR, "lstm.pt")           # saved in /neural_models/lstm/
WINDOW_SIZE = 4
BATCH_SIZE = 128
EPOCHS = 10
LR = 0.001
...
def train_model():
    ...
    model = LSTMRPSNet(input_dim=6, hidden_dim=64, output_dim=3).to(DEVICE)
